...
const RegisterComponent = ({ navigation }) => {
    ...
    const handleRegister = async () => {
        if (!username || !email || !password || password !== confirmPassword) {
            window.alert('Error. Por favor, complete todos los campos y asegúrese de que las contraseñas coincidan.');
            return;
        }
        ...
        try {
            ...
            await AsyncStorage.setItem('password', password); // Sin JSON.stringify
            await AsyncStorage.setItem('user', username); // Sin JSON.stringify
